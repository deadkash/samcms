...
/* gallery/views/edit/templates/edit_size.twig */
class __TwigTemplate_ef09b41637a83ce111aca5450e4b911a extends Twig_Template
{
    ...
    <h1>";
        ...
        echo $this->getAttribute($_ln_, "gallery_edit_size");
        echo "</h1>
    <form action=\"";
        // line 3
        ...
        // line 7
        if (isset($context["size_id"])) { $_size_id_ = $context["size_id"]; } else { $_size_id_ = null; }
        echo $_size_id_;
        echo "</span>
            </div>
        </div>
    ...
    {
        return "gallery/views/edit/templates/edit_size.twig";
    }
